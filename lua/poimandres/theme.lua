...
function M.get(config)
  ...
  theme = {
    ...
    -- -----------------------------------------------------------------------
    ['@tag.template'] = { fg = p.blue2 }, -- Change vue elements color to distingish them from other html element
    ['@string.vue'] = { fg = p.blueGray1 }, -- Change string color in html element
    -- -----------------------------------------------------------------------
    -- END: Additions
    -- -----------------------------------------------------------------------
